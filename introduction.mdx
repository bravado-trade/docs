...
description: "Infrastructure layer for Prediction Markets. Bravado provides REST APIs for order execution, copy-trading, and analytics. Build trading bots, dashboards, and social trading features."
icon:
  name: "book-open"
  library: "lucide"
---
