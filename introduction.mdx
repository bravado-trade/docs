---
title: "Infrastructure layer for Prediction Markets"
...
| **Data API** | `https://partner-api.bravadotrade.com/trader-analytics` | Leaderboards, wallet PnL, trade logs, tax statements |

## Your first request

The Data API's tax-report surface is public — run this with zero setup, no key required. (The rest of the Data API is signed with your partner key from the [portal](https://portal.bravadotrade.com/); see [Data API authentication](/products/data-api#authentication).)

<CodeGroup>

```bash cURL
curl "https://partner-api.bravadotrade.com/trader-analytics/traders/0x3a2b1c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b/tax-report"
```

```typescript TypeScript
const res = await fetch(
  "https://partner-api.bravadotrade.com/trader-analytics/traders/0x3a2b1c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b/tax-report",
);
