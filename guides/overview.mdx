...
- **Base URLs.** Trade, Copytrade, and Combos live under `https://partner-api.bravadotrade.com/v2/trade`. The Data API is at the root of the same host.
- **Auth.** A fresh HMAC signature on each request, including retries. See [authentication](/authentication).
