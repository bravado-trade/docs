...
<CardGroup cols={2}>
  <Card title="Polymarket" icon="/logo/polymarket.png" href="/guides/polymarket" horizontal>
    The largest prediction market by volume, on Polygon. Fully supported across every Bravado product, and every guide below works against it today.
  </Card>

  <Card title="Predict.fun" icon="/logo/predict-fun.png" href="/guides/predict-fun" horizontal>
    Supported for a subset of products. Coverage is being confirmed, so guides are not written yet.
  </Card>
</CardGroup>
