...
Requests are signed with your partner API key (`analytics.read` scope) and require the `polymarket` venue on your partner account — enabled by default. See [Data API authentication](/products/data-api#authentication).
