...
description: "Order execution and position management on Polymarket via the Bravado Trade API v2, including standard, advanced and conditional orders."
icon:
...
`TRAILING_BUY` additionally requires its deployment feature to be enabled. See [trailing buy](/products/trade-api#trailing-buy).
