...
Bravado connects to these venues so you integrate once instead of per-venue. Product and feature coverage differ by venue; use the table below to choose the relevant API.

<CardGroup cols={2}>
  <Card title="Polymarket" icon="/logo/polymarket.png" href="/markets/polymarket/overview">
    The largest prediction market by volume, running on Polygon. Fully supported across every Bravado product.
  </Card>

  <Card title="Predict.fun" icon="/logo/predict-fun.png" href="/markets/predict-fun/overview">
...
| --- | --- | --- |
| [Order-book WebSockets](/api/market-data/venue-order-books) | Supported | Supported |
| [Enriched live trade feed](/api/market-data/trade-feed) | Supported | Not available |
| [Trader Data API](/products/data-api) | Supported | Supported |
...
| [Combos API](/api/combos/overview) | Supported | Not applicable |
| [PMWAS, tax and entity rollups](/products/data-api#accounting-coverage) | Supported for covered wallets | Not available |
| [UMA API](/products/uma-api) | Contact us for access and endpoint details | Not applicable |
