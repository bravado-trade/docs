...
Bravado supports Predict.fun through the **Trade API v2**, **Trader Data API**, and **live order-book WebSockets**. Trade requests use `"venue": "predictfun"`; analytics use `/trader-analytics/predict/`; order books use `/stream/predictfun/partner`.
...
| [Trader Data API](/markets/predict-fun/data-api) | Supported — profiles, PnL, positions, trades, categories and leaderboards |
| [Order-book WebSockets](/api/market-data/venue-order-books) | Supported — live snapshots and updates |
| Combos API | Not available |

Tax statements, PMWAS reconciliation and entity rollups are Polymarket-only. Predict.fun order-book coverage does not include a public enriched trade tape.
...
<CardGroup cols={2}>
  ...
  <Card title="Trader Data API" icon="chart-line" href="/markets/predict-fun/data-api">
    Read wallet performance, positions, trades and leaderboards.
  </Card>
</CardGroup>
