...
Bravado supports Predict.fun through the **Trade API v2**, **Trader Data API**, and **live order-book WebSockets**. Trade requests use `"venue": "predictfun"`; analytics use `/trader-analytics/predict/`; order books use `/stream/predictfun/market`.
