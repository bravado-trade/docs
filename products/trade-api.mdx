...
description: "The Bravado Trade API covers the full order lifecycle on supported prediction markets: eight order types, bracket orders, and position management including redeem, split, and merge."
icon:
