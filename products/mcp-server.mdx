...
<Info>
  The MCP server is one of several ways to build AI applications on Bravado, the agent-native path for reading trader intelligence. For how it fits alongside realtime [Market Data](/products/market-data), the [Trader Data API](/products/data-api), and execution through the [Trade API](/products/trade-api), start with the [Build with AI](/build-with-ai) guide.
</Info>
