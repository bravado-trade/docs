...
Your portal account must be linked to a Bravado partner, and that partner needs the **Data API** product enabled. The venue you query (Polymarket, or Predict.fun) must also be enabled on the account — see [Venues](/products/data-api#venues).
