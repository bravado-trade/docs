...
<Info>
  For UMA integration, contact Bravado for the current endpoint list, access setup and historical coverage. The public endpoint reference is being updated.
</Info>
...
<Note>
  Bravado provides the current UMA endpoint details and integration examples directly during onboarding. Confirm the required resolution records and date range with the team. Redeeming positions is a separate operation in the [Trade API](/api/trade/positions).
</Note>
