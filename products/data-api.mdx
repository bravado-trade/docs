...
```bash
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0x3a2b1c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b?window=30d
```
...
<Tabs>
  <Tab title="PnL leaderboard">
    ...
    ```bash
    GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/leaderboard?window=24h
    ```
  </Tab>
  <Tab title="Volume leaderboard">
    ...
    ```bash
    GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/leaderboard/volume?window=7d
    ```
  </Tab>
</Tabs>
...
```bash
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}?window=30d
```
...
```bash
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}/tax-report?year=2025
```