...
<Note>Authenticate with HMAC. Signature values in request examples are placeholders; compute a fresh signature over the exact method, path and body. See [authentication](/authentication) and the [runnable quickstart](/quickstart-trade).</Note>
...
| Header | Value |
|--------|-------|
| HMAC headers | [Public key, timestamp and signature](/authentication) |
