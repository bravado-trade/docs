...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}/trades
```
...
```bash First page
curl -G https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0xabc.../trades \
