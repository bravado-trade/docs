...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}/tax-report
```
...
```bash cURL
curl -G https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0xabc.../tax-report \
