...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/entity/{owner}
```
...
```bash cURL
curl https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/entity/owner_01HXYZ \
