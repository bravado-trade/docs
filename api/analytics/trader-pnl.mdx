...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}/pnl
```
...
```bash cURL
curl -G https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0xabc.../pnl \
