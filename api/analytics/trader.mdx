...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}
```
...
```bash cURL
curl -G https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0xabc123def456abc123def456abc123def456abc1 \
