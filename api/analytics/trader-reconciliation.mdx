...
api: "GET /trader-analytics/traders/{address}/reconciliation"
...
```text
GET https://partner-api.bravadotrade.com/trader-analytics/traders/{address}/reconciliation
```
...
```bash cURL
curl https://partner-api.bravadotrade.com/trader-analytics/traders/0xabc.../reconciliation \
