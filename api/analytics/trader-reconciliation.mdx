...
```text
GET https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/{address}/reconciliation
```
...
```bash cURL
curl https://bravado-api-k7kaq.ondigitalocean.app/trader-analytics/traders/0xabc.../reconciliation \
