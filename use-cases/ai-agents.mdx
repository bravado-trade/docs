...
- **Hosted MCP server.** For agent frameworks that speak the Model Context Protocol, Bravado hosts a read-only analytics server at `https://mcp.bravadotrade.com/`, authorized with OAuth 2.1. See the [MCP server reference](/products/mcp-server).
