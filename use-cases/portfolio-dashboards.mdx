...
description: "Build portfolio dashboards and PnL trackers for Polymarket wallets with the Bravado Analytics API."
icon:
  name: "chart-pie"
  library: "lucide"
---
...
The Analytics API returns every field a full portfolio dashboard needs, on any Polymarket wallet:
...
All PnL numbers are computed under [PMWAS](/concepts/pnl-methodology), so cost basis is consistent across every response.
...
- [Analytics API reference](/api/analytics/overview)