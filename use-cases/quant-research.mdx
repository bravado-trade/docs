...
description: "Pull historical Polymarket trade, position, and PnL data for quant research and backtesting with the Bravado Analytics API."
icon:
  name: "flask-conical"
  library: "lucide"
---
...
- All PnL computed under [PMWAS](/concepts/pnl-methodology), so backtests reconcile with the live Analytics endpoints.
