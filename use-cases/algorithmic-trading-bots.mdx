---
title: "Algorithmic Trading Bots on Polymarket"
sidebarTitle: "Algorithmic trading bots"
description: "Execute algorithmic strategies on Polymarket's thin prediction-market order books with Bravado's TWAP, Iceberg, and Pegged order types."
icon:
  name: "bot"
  library: "lucide"
---
...
- [Guide: Execute a large position with TWAP \+ Iceberg](/guides/large-position-twap-iceberg)
- [Concept: Orders](/concepts/orders)
- [Concept: CLOB](/concepts/clob)
